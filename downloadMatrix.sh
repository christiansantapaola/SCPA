...
wget https://suitesparse-collection-website.herokuapp.com/MM/Bai/olm1000.tar.gz

wget https://suitesparse-collection-website.herokuapp.com/MM/Sandia/adder_dcop_32.tar.gz

wget https://suitesparse-collection-website.herokuapp.com/MM/HB/west2021.tar.gz

wget https://suitesparse-collection-website.herokuapp.com/MM/DRIVCAV/cavity10.tar.gz

wget https://suitesparse-collection-website.herokuapp.com/MM/Zitney/rdist2.tar.gz

wget https://suitesparse-collection-website.herokuapp.com/MM/Williams/cant.tar.gz

wget https://suitesparse-collection-website.herokuapp.com/MM/Simon/olafu.tar.gz
...
wget https://suitesparse-collection-website.herokuapp.com/MM/Bai/mhd4800a.tar.gz

wget https://suitesparse-collection-website.herokuapp.com/MM/Williams/cop20k_A.tar.gz

wget https://suitesparse-collection-website.herokuapp.com/MM/Simon/raefsky2.tar.gz
...
wget https://suitesparse-collection-website.herokuapp.com/MM/Botonakis/FEM_3D_thermal1.tar.gz

wget https://suitesparse-collection-website.herokuapp.com/MM/Schmid/thermal1.tar.gz
